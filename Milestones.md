...
[x] **Milestone 2**: The GitHub Webhook & Pipeline. Create the GitHub App securely, write the webhook receiver, and implement the background worker pipeline.

[x] **Milestone 3**: The C++ Analyzer. Write the C++ tool using CMake, parse a simple code structure, output JSON, and write the Python wrapper to execute it.
